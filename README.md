...
- The lookup table (json file generated from the shapefile) which maps areas to their coordinates is stored in **\<PlanSys2\>/src/UPF4ROS2/upf4ros2_demo/params**
- PDDL problem and domain files are stored in **\<PlanSys2\>/src/UPF4ROS2/upf4ros2_demo/test/pddl** and parsed within plan_executor.py.
